...
<head>
  ...
  <style>
    ...
    .overlay-logo {
      width: 150px; /* kamu bisa ubah ukuran sesuai desain */
      height: auto;
      display: block;
  ...
  .btn-gradient-outline {
    ...
    background-image:
        linear-gradient(white, white),                                  /* isi tombol */
        linear-gradient(to bottom, #162660, #2D4EC6);                  /* border gradient */
  ...
  .btn-gradient-outline:hover {
    background-image:
        linear-gradient(to bottom, #162660, #2D4EC6),  /* sekarang isi = gradient */
        linear-gradient(to bottom, #162660, #2D4EC6);  /* border tetap gradient (blend-safe) */

...
<head>
  ...
  <title>@yield('title', 'Dashboard Warga RT 07')</title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto align-items-center gap-3">
          <li class="nav-item ">
            <a class="nav-link {{--{{ Request::is('/') ? 'active' : '' }}--}} " href="/warga/homepage">Beranda</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ Request::is('pengumuman') ? 'active' : '' }} " href="/warga/pengumuman">Pengumuman</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ Request::is('materi') ? 'active' : '' }}" href="/warga/materi">Materi</a>
          </li>

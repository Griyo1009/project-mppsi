...
@section('title', 'Profil | Warga RT 07')
...
.profile-wave-separator {
    position: relative;
    height: 60px; /* Tinggi pemisah */
    background-color: #162660; /* Harus sama dengan BG profile section */
}

.profile-wave-separator::after {
    content: '';
    position: absolute;
    bottom: -1px; /* Naikkan sedikit agar tidak ada celah */
    left: 0;
    right: 0;
    height: 60px; 
    /* SVG: Gelombang putih (#fff) di atas BG biru tua */
    ...
    <form action="{{ route('admin.profile.update.photo') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="text-center mb-2">
            ...
            <div>
                ...
                <button type="submit" class="btn btn-outline-light d-none px-4" id="savePhotoBtn">Simpan Foto</button>
            </div>
        </div>
    </form>
